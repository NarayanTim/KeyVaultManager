  ...
  return (
    ...
    >
      <div className="mb-4 flex h-16 w-16 items-center justify-center rounded-full bg-secondary-100 dark:bg-secondary-800">
        <Icon className="h-8 w-8 text-secondary-400 dark:text-secondary-500" />
      </div>
      ...
      {description && (
        <p className="mb-4 max-w-sm text-sm text-secondary-500 dark:text-secondary-400">
          {description}
        </p>
      )}
...
export const ErrorState = ({
  ...
  return (
    ...
    >
      <div className="mb-4 flex h-16 w-16 items-center justify-center rounded-full bg-error-100 dark:bg-error-900/30">
        <AlertCircle className="h-8 w-8 text-error-500 dark:text-error-400" />
      </div>
...
export const LoadingState = ({
  ...
  return (
    ...
    >
      <div className="h-10 w-10 animate-spin rounded-full border-2 border-secondary-300 border-t-primary-600" />
